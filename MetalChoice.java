...
public class MetalChoice {
 ...
 public static void main(String [] args) {
    ...
    *********************************************/     
      ...
      if ((metalType == 'A') && (namePlate == 'g') && (totalLetters <= 5)) {
          double priceA1 = (ALUMINUM_COST_PER_INCH * totalArea) + GOLD_COST + FIRST_FIVE;
      ...
      if ((metalType == 'A') && (namePlate == 'g') && (totalLetters >= 6) && (totalLetters <= 10 )) {
          double priceA2 = (ALUMINUM_COST_PER_INCH * totalArea) + GOLD_COST + (FIRST_FIVE + ((totalLetters - 5) * SIX_TO_TEN_PER_LETTER));
      ...
      if ((metalType == 'A') && (namePlate == 'g') && (totalLetters > 10)) {
          double priceA3 = (ALUMINUM_COST_PER_INCH * totalArea) + GOLD_COST + (FIRST_FIVE + (((totalLetters - 10) * TEN_OR_MORE_PER_LETTER) * SIX_TO_TEN_PER_LETTER));
